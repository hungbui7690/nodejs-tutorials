/*  
  ...
  *** Note: res.status(201).json({ success: true, person: name })
    >> server must send the correct format: { success: true, person: name } >> so that client (JS) can access and update UI
...
// (4) in this lesson, we will work with this route
