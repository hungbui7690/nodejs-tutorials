/*
  ...
  > chúng ta có thể sử dụng unique id library để tạo ra token
  > nhưng cũng có thể làm tốt hơn khi sử dụng crypto library >> đc build sẵn trong nodejs >> chúng ta ko cần phải cài gì cả 
...
===========================================================
  ...
  xong bước 2 là xong phần token
...
==================================================
  ...
  giờ tới phần verify email >> PIC: verify-email
